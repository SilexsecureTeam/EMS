          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
            ...
            <div className="w-full lg:w-1/2 lg:pl-7">
              ...
              <h2 className="text-[32px] font-semibold text-[#333333] mb-4">We're here to help</h2>
                ...
                <div className="flex gap-x-9 items-center faq-btn gap-5">
             <button className='bg-[#C3AA8C] w-fit cursor-pointer text-lg text-[#193728] border-2 border-[#193728] py-3 px-7'>READ FAQS</button>
